...
$container = apply_filters('emd_change_container','emd-wrapper','request_a_quote', 'taxonomy');  
...
<?php
	do_action('emd_tax_before_header', 'request-a-quote',$post->post_type,$queried_object->taxonomy);
	emd_get_template_part('request-a-quote', 'taxonomy', str_replace("_","-",$queried_object->taxonomy . '-' . $post->post_type) . '-theader');
	do_action('emd_tax_after_header', 'request-a-quote',$post->post_type,$queried_object->taxonomy);
?>
	</div>
...
<?php
	do_action('emd_tax_before_footer', 'request-a-quote',$post->post_type,$queried_object->taxonomy);
	emd_get_template_part('request-a-quote', 'taxonomy', str_replace("_","-",$queried_object->taxonomy . '-' . $post->post_type) . '-tfooter');
	do_action('emd_tax_after_footer', 'request-a-quote',$post->post_type,$queried_object->taxonomy);
?>
</div>
