...
</tr><tr><th style='font-size:1.1em;color:cadetblue;border-bottom: 1px dashed;padding-bottom: 10px;' colspan=2><div><?php _e('Taxonomies', 'request-a-quote'); ?></div></th></tr>
<tr>
...
<tr>
<th><?php _e('Quote Status', 'request-a-quote'); ?></th>

<td><?php _e(' Quote Status accepts multiple values like tags', 'request-a-quote'); ?>. <?php _e('Quote Status has a default value of:', 'request-a-quote'); ?> <?php _e(' pending', 'request-a-quote'); ?>. <div class="taxdef-block"><p><?php _e('The following are the preset values for <b>Quote Status:</b>', 'request-a-quote'); ?></p><p class="taxdef-values"><?php _e('Pending', 'request-a-quote'); ?>, <?php _e('Cancelled', 'request-a-quote'); ?>, <?php _e('Expired', 'request-a-quote'); ?>, <?php _e('Accepted', 'request-a-quote'); ?>, <?php _e('Declined', 'request-a-quote'); ?></p></div></td>
</tr>
</table>
</div>
</div>
